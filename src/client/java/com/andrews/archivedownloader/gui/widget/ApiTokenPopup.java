...
public class ApiTokenPopup implements Drawable, Element {
    ...
    public ApiTokenPopup(
        ...
        int measuredDescriptionHeight = RenderUtil.getWrappedTextHeight(client.textRenderer, descriptionText, messageWidth);
        int fixedHeight =
        ...
        tokenField.setPlaceholder(Text.of(hasExistingToken
    ...
    private void saveToken() {
        onSave.accept(tokenField.getText());
    }
